...
describe('Testing Ecommerce', () => {
    ...
    describe('Test de productos', () => {
        ...
        // it.skip('endpoint PUT /api/products/:id => debe actualizar un producto existente', async () => {
        ...
        //     const prodId = product.body.payload._id
        ...
        // it.skip('endpoint DELETE /api/products/:id => debe eliminar un producto', async () => {
        ...
        //     const deleteRequestStatus = await requester.delete(`/api/products/${prodId}`)
        //     expect(deleteRequestStatus.ok).to.be.true
        //     expect(deleteRequestStatus.statusCode).to.be.equal(200)

        //     // hacer un getAll y ver que no está
        //     const getAllRequestStatus = await requester.get('/api/products')
        //     expect(getAllRequestStatus.ok).to.be.true
        //     expect(getAllRequestStatus.statusCode).to.be.equal(200)

        //     const deletedProduct = getAllRequestStatus.body.payload.find(p => p._id === prodId)
